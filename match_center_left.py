...
for i in range(1,10):
    ...
    template = cv2.imread('/home/hai/python_work/match_template/templeclub/003.png',0)
    ...
    cv2.imwrite('/home/hai/python_work/match_template/resultcenterleft/' + str(i) + '.jpeg',viso)
    cv2.waitKey(500)
