...
for i in range(1,100):
    ...
    template = cv2.imread('/home/hai/python_work/match_template/templeclub/005.png',0)
    ...
    for pt in zip(*loc[::-1]):
        ...
        if (((pt[0] + pt[0] + w)/2 < 500) and ((pt[1] + pt[1] + h)/2 < 500) and ((pt[0] + pt[0] + w)/2 > 200) and ((pt[1] + pt[1] + h)/2 > 200) ) :
    ...
    cv2.imwrite('/home/hai/python_work/match_template/resultcornerleft/' + str(i) + '.jpeg',viso)
    cv2.waitKey(50)
